...
public class TestAccountLogic
{
    ...
    public void UpdateList_ExistingAccount_UpdateSuccessful()
    {
        ...
        // Arrange
        var existingAccount = new AccountModel(1, "test@example.com", "password", "John Doe", default, "1234567890", ["Dough"], [3], "client");
        _accountsLogic.UpdateList(existingAccount);

        var updatedAccount = new AccountModel(1, "updated@example.com", "newpassword", "John Doe", default, "0987654321", ["Dough"], [3], "client");
    ...
    {
        // Arrange
        var newAccount = new AccountModel(2, "richard@example.com", "richardpassword", "Richard Morris", default, "0653269420", ["spicy food"], [], "client");
    ...
    {
        // Arrange
        var account = new AccountModel(2, "richard@example.com", "richardpassword", "Richard Morris", default, "0653269420", ["spicy food"], [], "client");
