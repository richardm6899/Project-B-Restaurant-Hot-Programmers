...
public class TestReservationLogic
{
    ...
    public void TestCreateTableTest(int chairs, int minCapacity, int maxCapacity)
    {
        ...
        TableModel table = reservationlogic.Createtable(chairs, minCapacity, maxCapacity);
    ...
    public void TestCreateReservation()
    {
        ...
        TableModel table = reservationlogic.Createtable(10, 9, 10);
        // create reservation and assign to table
        ReservationModel reservation = reservationlogic.Create_reservation(table.Id, "Yapper", 10, 10, DateTime.Today);
    ...
    {
        ReservationLogic reservationlogic = new();
        ReservationModel reservation = reservationlogic.Create_reservation(100, "Yapper", 10, 10, DateTime.Today);
